...
public class BaseUi extends Activity {
	...
	public void overlayAndResult (Class<?> classObj,int requestCode) {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
        intent.setClass(this, classObj);
...
//		}
	...
	public void loadImage2 (final String url) {
		taskPool.addTask(0, new BaseTask(){
			@Override
			public void onComplete(){
				AppCache.getCachedImage(getContext(), url);
				sendMessage(BaseTask.LOAD_IMAGE2);
			}
		}, 0);
	}
	////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void enLargePic (Bundle data) {
		Intent intent = new Intent();
		intent.setAction(C.intent.action.ENLARGEPIC);
		intent.putExtras(data);
		Log.e("errorhaha", "16");
		this.startActivity(intent);
	}
