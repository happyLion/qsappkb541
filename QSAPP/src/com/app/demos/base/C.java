...
public final class C {
	...
	public static final class api {
		// 建议换成你的内网IP的地址
		public static final String base				= "http://app.myqsmy.com:8001";//"";
		//debug的时候用的内网后台地址，后面的ip是gouchaoer配置好的php后台开发地址，8002的地址是8001返回的，所以不用再修改
		public static final String baseDebug		= "http://121.49.73.191:8001";
//		public static final String base				= "http://10.0.2.2:8001";
	...
	public static final class task {
		...
		public static final int blogListAgain       = 1016;
	}
	...
	public static final class intent {
		public static final class action {
			...
			public static final String ENLARGEPIC	= "com.app.demos.ENLARGEPIC";
		}
	}
	...
	public static final class web {
		// 建议换成你的内网IP的地址
		public static final String base				= "http://app.myqsmy.com:8002";
